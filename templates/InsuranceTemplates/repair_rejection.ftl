...
<head>
  ...
  <title>Repair Re-Inspection Rejected</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <h2>Repair Re-Inspection Rejected</h2>
    </div>
    <div class="content">
      <p>Dear ${recipientName!policyNumber},</p>
      <p>Re-inspection did not approve the repair outcome and the claim has been rejected at this stage.</p>
      <p>${messageContent!""}</p>
      <div class="meta">
