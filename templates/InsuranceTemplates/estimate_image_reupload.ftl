...
<head>
  ...
  <title>Survey Images Re-Upload Required</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <h2>Survey Images Re-Upload Required</h2>
    </div>
    <div class="content">
      <p>Dear ${recipientName!policyNumber},</p>
      <p>Survey images are not sufficient for estimate approval and must be re-uploaded.</p>
      <p>${messageContent!""}</p>
      <div class="meta">
