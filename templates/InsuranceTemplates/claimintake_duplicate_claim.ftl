...
<head>
  ...
  <title>Duplicate Claim Notification</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <h2>Duplicate Claim Notification</h2>
    </div>
    <div class="content">
      <p>Dear ${recipientName!policyNumber},</p>
      <p>Your claim request has been identified as a duplicate record during claim intake verification.</p>
      <p>${messageContent!""}</p>
      <div class="meta">
