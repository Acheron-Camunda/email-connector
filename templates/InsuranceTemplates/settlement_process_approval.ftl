...
<head>
  ...
  <title>Settlement Process Approval</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <h2>Settlement Process Approval</h2>
    </div>
    <div class="content">
      <p>Dear ${recipientName!policyNumber},</p>
      <p>Process approval notification has been generated for settlement completion.</p>
      <p>${messageContent!""}</p>
      <div class="meta">
