...
<head>
  ...
  <title>Quality Validation Update</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <h2>Quality Validation Update</h2>
    </div>
    <div class="content">
      <p>Dear ${recipientName!policyNumber},</p>
      <p>Quality validation communication has been sent for this claim settlement stage.</p>
      <p>${messageContent!""}</p>
      <div class="meta">
